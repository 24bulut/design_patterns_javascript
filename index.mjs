...
import { CreditCardPayment } from "./Patterns/BehavioralPatterns/StrategyPattern/CreditCardPayment.mjs";
import { PayPalPayment } from "./Patterns/BehavioralPatterns/StrategyPattern/PayPalPayment.mjs";
import { CryptoPayment } from "./Patterns/BehavioralPatterns/StrategyPattern/CryptoPayment.mjs";
import { PaymentContext } from "./Patterns/BehavioralPatterns/StrategyPattern/PaymentContext.mjs";

const cartAmount = 500;

const payment = new PaymentContext(new CreditCardPayment());
payment.executePayment(cartAmount); // Output: Kredi kartı ile 500 TL ödendi.

payment.setStrategy(new PayPalPayment());
payment.executePayment(cartAmount); // Output: PayPal ile 500 TL ödendi.

payment.setStrategy(new CryptoPayment());
payment.executePayment(cartAmount); // Output: Kripto para ile 500 TL ödendi.

// 3.8 Template Method Pattern
import { JSONDataProcessor } from "./Patterns/BehavioralPatterns/TemplateMethodPattern/JSONDataProcessor.mjs";
import { XMLDataProcessor } from "./Patterns/BehavioralPatterns/TemplateMethodPattern/XMLDataProcessor.mjs";
